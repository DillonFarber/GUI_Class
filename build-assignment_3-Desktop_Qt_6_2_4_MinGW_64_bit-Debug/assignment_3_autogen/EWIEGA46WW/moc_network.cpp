...
#include <memory>
#include "../../../assignment_3/network.h"
...
QT_MOC_LITERAL(8, 20), // "sensingDistanceTicks"
QT_MOC_LITERAL(29, 0), // ""
QT_MOC_LITERAL(30, 13), // "lengthOfCable"
QT_MOC_LITERAL(44, 13), // "numberOfTicks"
QT_MOC_LITERAL(58, 13), // "messageLength"
QT_MOC_LITERAL(72, 20), // "probabilityOfMessage"
QT_MOC_LITERAL(93, 3) // "run"

    },
    "network\0sensingDistanceTicks\0\0"
...
void network::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sensingDistanceTicks((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->lengthOfCable((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->numberOfTicks((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->messageLength((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->probabilityOfMessage((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 5: _t->run(); break;
        default: ;
        }
    }
